...
public class SharedResourcesService : ISharedResourcesService
{
    ...
    public string GetString(string resourceId, CultureInfo cultureInfo)
    {
        ...
        try
        {
            ...
            {
                resourceManager = new ResourceManager("Students.Resources.ResourcesGerman", typeof(ResourcesPolish).Assembly);
            }

            else if (string.Equals(cultureInfo.Name, "ja-JP"))
            {
                resourceManager = new ResourceManager("Students.Resources.ResourcesJapan", typeof(ResourcesPolish).Assembly);
            }
